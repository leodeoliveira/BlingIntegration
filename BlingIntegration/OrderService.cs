...
namespace BlingIntegration
{
    public class OrderService
    {
        ...
        public static void PrepareOrderFile(string apiKey)
        {
            ...
            string fileName = DefaultFormat.GetFileName("order");
        ...
        public static List<string> ExecuteGetOrder(string apiKey, bool lastSevenDays)
        {
            ...
            while (hasData)
            {
                string url = string.Format("https://bling.com.br/Api/v2/pedidos/page={0}/json&apikey={1}&filters=idSituacao[9,39780]", counter,
                    apiKey);
